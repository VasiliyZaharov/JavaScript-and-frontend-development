...
<br>
:arrow_down: [Модуль E12 Сборка проекта](README.md#Модуль-E12-Сборка-проекта)
<br>
:arrow_down: [Модуль E13 Автоматизация рутины](README.md#Модуль-E13-Автоматизация-рутины)
<br>
...
# Модуль E12 Сборка проекта

<p>1. Принцип SPA</p>

<p>2. Сборщики webpack, parcel</p>

<p>3. JS-модули и CSS-модули</p>
<ul>
<li>JS модули</li>
<li>CSS модули</li>
<li>Подключаем CSS к Webpack</li>
</ul>

<p>4. Шаблонизаторы (Pug)</p>

<p>5. Минификаторы</p>

<p>6. Типизация в JavaScript</p>
<ul>
<li>Flow</li>
<li>TypeScript</li>
</ul>

<p>7. Дополнительные инструменты для качества кода</p>
<ul>
<li>ESLint</li>
<li>CSS lint</li>
</ul>

 # Модуль E13 Автоматизация рутины
...
<hr>
Ссылка на модуль: 
https://github.com/VasiliyZaharov/JavaScript-and-frontend-development/tree/main/Module%20E13.%20Routine%20automation
<hr>
...
Страница открывается по URL http://localhost:8081/
